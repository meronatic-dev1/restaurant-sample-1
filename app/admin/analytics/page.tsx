        ...
        <div style={{ maxWidth: 1200, fontFamily: '"DM Sans", system-ui, sans-serif', display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <div style={{ ...card, animation: 'fadeUp 0.4s ease both', animationDelay: '0.06s' }}>
                <div style={cardHeader}>
                    <div style={iconBadge('#3b82f6')}><Star size={13} style={{ color: '#3b82f6' }} /></div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, animation: 'fadeUp 0.4s ease both', animationDelay: '0.12s' }}>
                ...
                <div style={card}>
                    <div style={cardHeader}>
                        <div style={iconBadge('#3b82f6')}><Users size={13} style={{ color: '#3b82f6' }} /></div>
            ...
            <div style={{ ...card, animation: 'fadeUp 0.4s ease both', animationDelay: '0.18s' }}>
                <div style={cardHeader}>
                    <div style={iconBadge('#3b82f6')}><Clock size={13} style={{ color: '#3b82f6' }} /></div>
                                    ...
                                    {data.peakHoursHeatmap[day]?.map((val, hi) => (
                                        <div
                                            ...
                                            style={{
                                                ...
                                                background: `rgba(59,130,246,${(val / 9) * 0.82 + 0.04})`,
                                                border: val >= 8 ? '1px solid rgba(59,130,246,0.3)' : '1px solid transparent',
                                                boxShadow: val >= 8 ? `0 0 6px rgba(59,130,246,${val / 9 * 0.4})` : 'none',
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 12, justifyContent: 'flex-end' }}>
                            ...
                            {[0.08, 0.26, 0.45, 0.63, 0.9].map(op => (
                                <div key={op} style={{
                                    ...
                                    border: op >= 0.7 ? '1px solid rgba(59,130,246,0.35)' : '1px solid transparent',
                                }} />
                            ))}
            ...
            <div style={{ ...card, animation: 'fadeUp 0.4s ease both', animationDelay: '0.24s' }}>
                <div style={cardHeader}>
                    <div style={iconBadge('#3b82f6')}><ShoppingBag size={13} style={{ color: '#3b82f6' }} /></div>
                        ...
                        return (
                            <div key={c.name} style={{
                                ...
                                <div style={{ display: 'flex', gap: 20, flexShrink: 0, textAlign: 'right' }}>
                                    <span style={{ fontSize: 12, fontWeight: 800, color: '#3b82f6', minWidth: 88, letterSpacing: '-0.02em' }}>
