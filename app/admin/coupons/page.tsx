        ...
        <div>
            ...
            <div style={{
                ...
                {filteredCoupons.map(c => (
                    <div key={c.id} style={{
                        background: 'rgba(255,255,255,0.02)',
                        border: `1px solid ${c.isActive ? 'rgba(255,255,255,0.08)' : 'rgba(59,130,246,0.2)'}`,
                    ...
                    <div style={{ width: '100%', maxWidth: 440, background: '#111115', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 20, overflow: 'hidden' }}>
                        ...
                        <form onSubmit={handleSubmit} style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 16 }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginTop: 4 }}>
                                <input type="checkbox" id="isActive" checked={formData.isActive} onChange={e => setFormData({ ...formData, isActive: e.target.checked })} style={{ accentColor: '#3b82f6', width: 16, height: 16 }} />
                            ...
                            <div style={{ display: 'flex', gap: 12, marginTop: 16 }}>
                                ...
                                <button type="submit" disabled={isSubmitting} style={{ flex: 1, padding: 12, background: '#3b82f6', border: 'none', borderRadius: 10, color: '#fff', fontSize: 14, fontWeight: 700, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
