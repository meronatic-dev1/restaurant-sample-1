...
const AVATAR_COLORS = ['#3b82f6', '#a855f7', '#14b8a6', '#fbbf24', '#fb7185', '#60a5fa', '#a78bfa'];
                ...
                <>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 12, marginBottom: 20, animation: 'fadeUp 0.4s ease both', animationDelay: '0.06s' }}>
                        {[
                            ...
                            { label: 'Disabled', value: disabledCount, color: '#fb7185', glow: 'rgba(251,113,133,0.1)', border: 'rgba(251,113,133,0.18)' },
                            { label: 'Total Spend', value: `AED ${totalSpend.toLocaleString()}`, color: '#3b82f6', glow: 'rgba(59,130,246,0.12)', border: 'rgba(59,130,246,0.22)' },
                        ].map((s, i) => (
                                                ...
                                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: 6 }}>
                                                    ...
                                                    <button
                                                        ...
                                                        style={{
                                                            ...
                                                            border: `1px solid ${active ? 'rgba(251,113,133,0.18)' : 'rgba(74,222,128,0.18)'}`,
                                                            display: 'flex', alignItems: 'center', justifyContent: 'center',
                                                            color: active ? 'rgba(251,113,133,0.5)' : 'rgba(74,222,128,0.5)',
                                                            cursor: 'pointer',
                                                            transition: 'all 0.15s',
                                                        }}
                                                        title={active ? 'Disable customer' : 'Enable customer'}
                                                        onMouseEnter={e => {
                                                            e.currentTarget.style.background = active ? 'rgba(251,113,133,0.1)' : 'rgba(74,222,128,0.1)';
                                                            e.currentTarget.style.borderColor = active ? 'rgba(251,113,133,0.35)' : 'rgba(74,222,128,0.35)';
                                                            e.currentTarget.style.color = active ? '#fb7185' : '#4ade80';
                                                        }}
                                                        onMouseLeave={e => {
                                                            e.currentTarget.style.background = 'transparent';
                                                            e.currentTarget.style.borderColor = active ? 'rgba(251,113,133,0.18)' : 'rgba(74,222,128,0.18)';
                                                            e.currentTarget.style.color = active ? 'rgba(251,113,133,0.5)' : 'rgba(74,222,128,0.5)';
                                                        }}
                                                    >
