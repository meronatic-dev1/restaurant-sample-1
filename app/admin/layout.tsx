...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    useEffect(() => {
        ...
        setLocation(prev => {
            if (prev?.branchId === effectiveBranchId) return prev;
            return {
                ...prev,
                lat: prev?.lat || 0,
                lng: prev?.lng || 0,
                address: prev?.address || '',
                mode: prev?.mode || 'Delivery',
        ...
        socket.on('newOrder', (order: any) => {
            ...
            if (typeof window !== 'undefined' && 'Notification' in window && Notification.permission === 'granted') {
                new Notification('New Order Received!', {
                    ...
                    icon: settings?.logoUrl || '/meronatic-logo.png',
                });
            }
        });
            ...
            <aside style={{
                ...
                <div style={{
                    ...
                    <div>
                        ...
                        <p style={{ fontSize: 9, color: 'rgba(59,130,246,0.7)', margin: 0, letterSpacing: '0.14em', textTransform: 'uppercase', fontWeight: 700 }}>
                            Admin Console
                        </p>
                    </div>
                </div>
                            ...
                            >
                                ...
                                {active && (
                                    <span style={{
                                        ...
                                        width: 3, height: 18,
                                        background: 'linear-gradient(to bottom, #3b82f6, #ff9a5c)',
                                ...
                                <Icon
                                    size={15}
                                    style={{ color: active ? '#3b82f6' : 'rgba(255,255,255,0.25)', flexShrink: 0 }}
                                />
                                {label}
                                {/* Active dot */}
                                {active && (
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        background: 'linear-gradient(135deg, #3b82f6, #cc4400)',
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
