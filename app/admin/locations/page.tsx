            ...
            <div style={{ background: '#13131a', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 20, padding: 28, width: 440, maxWidth: '95vw', boxShadow: '0 32px 80px rgba(0,0,0,0.8)' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                    <div>
                        ...
                        <input value={name} onChange={e => setName(e.target.value)} placeholder="e.g. Meronatic — Downtown"
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                        <div>
                            ...
                            <input type="time" value={openTime} onChange={e => setOpenTime(e.target.value)}
                                style={{ ...inputStyle, cursor: 'pointer' }} onFocus={e => (e.currentTarget.style.borderColor = 'rgba(59,130,246,0.5)')} onBlur={e => (e.currentTarget.style.borderColor = 'rgba(255,255,255,0.07)')} />
                        </div>
                        <div>
                        ...
                        >
                            ...
                            <div style={{
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                                    ...
                                    >
                                        {loc.isActive
                                            ? <ToggleRight size={24} style={{ color: '#3b82f6', filter: 'drop-shadow(0 0 5px rgba(59,130,246,0.5))' }} />
