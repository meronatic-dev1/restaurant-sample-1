            ...
            <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <div style={{
                        ...
                        <img src={settings?.logoUrl || '/meronatic-logo.png'} alt="Logo"
                            style={{ width: '100%', height: '100%', objectFit: 'contain', padding: 2 }} />
                    </div>
                    <div>
                        <p style={{ fontSize: 15, fontWeight: 700, color: '#fff', margin: 0, letterSpacing: '-0.02em' }}>Meronatic</p>
                ...
                <div>
                        ...
                        {stats.map((stat, i) => (
                            <div key={i} style={{
                                ...
                                <div style={{
                                    ...
                                    color: stat.up === true ? '#4ade80' : stat.up === false ? '#fb7185' : 'rgba(255,255,255,0.4)',
                                    background: stat.up === true ? 'rgba(74,222,128,0.12)' : stat.up === false ? 'rgba(251,113,133,0.12)' : 'rgba(255,255,255,0.06)',
                                    padding: '4px 10px',
                                    borderRadius: '20px',
                    ...
                    <h1 style={{
                        ...
                        Your restaurant,<br />
                        <span style={{
                            background: 'linear-gradient(90deg, #3b82f6, #ffb380)',
                            WebkitBackgroundClip: 'text',
                            WebkitTextFillColor: 'transparent',
                        }}>fully in control.</span>
                    </h1>
                    <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.45)', lineHeight: 1.7, margin: 0, maxWidth: '380px' }}>
                        Manage orders, update your menu, track analytics, and configure every detail of your Meronatic experience — all from one place.
                    </p>
                </div>
                ...
                <div style={{ width: '100%', maxWidth: '400px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <div style={{ marginBottom: '28px', width: '100%' }}>
                        ...
                        <div style={{
                            ...
                            <span style={{ fontSize: 10, fontWeight: 800, color: '#3b82f6', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
                                🔐 Restricted Access
                            </span>
                        </div>
