...
const STATUS_CFG: Record<OrderStatus, { color: string; bg: string; border: string; icon: React.ReactNode; barColor: string }> = {
    ...
    Preparing: { color: '#3b82f6', bg: 'rgba(59,130,246,0.08)', border: 'rgba(59,130,246,0.2)', icon: <ChefHat size={11} />, barColor: '#3b82f6' },
    ...
    Cancelled: { color: '#fb7185', bg: 'rgba(251,113,133,0.08)', border: 'rgba(251,113,133,0.2)', icon: <XCircle size={11} />, barColor: '#fb7185' },
};
            ...
            {open && (
                <div style={{
                    ...
                    <button
                        ...
                        onMouseLeave={e => (e.currentTarget.style.background = 'transparent')}
                    >
                        <div style={{ width: 32, height: 32, borderRadius: 9, background: 'rgba(251,113,133,0.12)', border: '1px solid rgba(251,113,133,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                            <FileText size={15} style={{ color: '#fb7185' }} />
                        </div>
                        <div>
    ...
    const handlePrint = (order: Order) => {
        ...
        const html = `
            <html>
                ...
                <body>
                    <div class="center">
                        ...
                        <div class="bold" style="font-size: 16px;">MERONATIC</div>
            ...
            return `
                    ...
                    <div class="footer">
                        <p>THANK YOU FOR CHOOSING MERONATIC!</p>
                        ...
                        >
                            ...
                            >
                                ...
                                <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1.4fr 1fr 1fr 0.8fr', gap: 16, minWidth: 0 }}>
                                    ...
                                    <div>
                                        <p style={{ fontSize: 11, fontFamily: 'monospace', color: '#3b82f6', fontWeight: 700, margin: '0 0 2px' }}>
                                            {order.displayId}
                                        </p>
                                ...
                                <div style={{
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: 'minmax(200px, 1fr) minmax(200px, 1fr) minmax(250px, 1.5fr)', gap: 24, paddingTop: 20 }}>
                                        ...
                                        <div>
                                            ...
                                            <div style={{ background: 'rgba(59,130,246,0.03)', border: '1px solid rgba(59,130,246,0.1)', borderRadius: 12, padding: '14px 16px', display: 'flex', flexDirection: 'column', gap: 10 }}>
                                                <div>
                                                    <p style={{ fontSize: 10, color: 'rgba(59,130,246,0.5)', margin: '0 0 2px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Mode</p>
                                                ...
                                                {order.customerStreet && (
                                                    <div>
                                                        <p style={{ fontSize: 10, color: 'rgba(59,130,246,0.5)', margin: '0 0 4px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Street Address</p>
                                                ...
                                                {order.customerCity && (
                                                    <div>
                                                        <p style={{ fontSize: 10, color: 'rgba(59,130,246,0.5)', margin: '0 0 2px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>City</p>
                                                        <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.7)', margin: 0 }}>{order.customerCity}</p>
                                                    </div>
                                                )}
                                                {order.customerPostcode && (
                                                    <div>
                                                        <p style={{ fontSize: 10, color: 'rgba(59,130,246,0.5)', margin: '0 0 2px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Postcode</p>
                                                        <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.7)', margin: 0 }}>{order.customerPostcode}</p>
                                                    </div>
                                                )}
                                                {order.deliveryInstructions && (
                                                    <div>
                                                        <p style={{ fontSize: 10, color: 'rgba(59,130,246,0.5)', margin: '0 0 2px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Delivery Instructions</p>
                                                        <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.7)', margin: 0, fontStyle: 'italic' }}>{order.deliveryInstructions}</p>
                                                    </div>
                                                )}
                                                {order.tableNo && (
                                                    <div>
                                                        <p style={{ fontSize: 10, color: 'rgba(59,130,246,0.5)', margin: '0 0 2px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Table No</p>
                                    ...
                                    <div style={{ display: 'flex', gap: 8, marginTop: 18, alignItems: 'center' }}>
                                        {NEXT[order.status] && (
                                            <button
                                                ...
                                                style={{
                                                    ...
                                                    background: 'linear-gradient(135deg, #3b82f6, #e55a00)',
                                        ...
                                        {!['Completed', 'Cancelled'].includes(order.status) && (
                                            <button
                                                ...
                                                onMouseEnter={e => { e.currentTarget.style.background = 'rgba(251,113,133,0.12)'; e.currentTarget.style.borderColor = 'rgba(251,113,133,0.35)'; }}
                                                onMouseLeave={e => { e.currentTarget.style.background = 'rgba(251,113,133,0.07)'; e.currentTarget.style.borderColor = 'rgba(251,113,133,0.2)'; }}
                                            >
                                        ...
                                        {order.status === 'Cancelled' && (
                                            <div style={{ display: 'flex', alignItems: 'center', gap: 5, fontSize: 12, color: '#fb7185', fontWeight: 700 }}>
