...
const MODE_COLORS: Record<string, { color: string; icon: React.ReactNode }> = {
    Delivery: { color: "#3b82f6", icon: <Bike size={20} /> },
    Pickup: { color: "#a855f7", icon: <Package size={20} /> },
    'Dine-In': { color: "#14b8a6", icon: <Utensils size={20} /> },
};
...
export default function AdminOverviewPage() {
    ...
    useEffect(() => {
        ...
        // Hardcoded Mock Data for sample
        const mockData: DashboardData = {
            ...
            recentOrders: [
                ...
                { id: 'ORD-1040', name: 'Mike Johnson', branch: 'JLT', total: 'AED 210.00', mode: 'Dine-In' },
                { id: 'ORD-1039', name: 'Emma Wilson', branch: 'Dubai Mall', total: 'AED 65.00', mode: 'Delivery' },
            ],
            recentCanceledOrders: [
                { id: 'ORD-1038', name: 'Ali Hassan', branch: 'Marina', total: 'AED 45.00', mode: 'Pickup' },
            ],
            topProducts: [
                { name: 'Spicy Tuna Roll', orders: 124, pct: 100 },
                { name: 'Salmon Sashimi', orders: 98, pct: 79 },
                { name: 'Dragon Roll', orders: 85, pct: 68 },
                { name: 'Miso Soup', orders: 72, pct: 58 },
                { name: 'Edamame', orders: 65, pct: 52 },
            ],
            totalItemsSold: 1254,
        };
    ...
    const kpis = data ? [
        { label: "Revenue", value: `AED ${data.kpis.revenue.toLocaleString('en-US', { minimumFractionDigits: 0 })}`, icon: DollarSign, color: "#3b82f6", glow: "rgba(59,130,246,0.15)" },
        { label: "Orders", value: data.kpis.orders.toLocaleString(), icon: ShoppingBag, color: "#a855f7", glow: "rgba(168,85,247,0.15)" },
        { label: "Canceled", value: data.kpis.cancelledOrders.toLocaleString(), icon: XCircle, color: "#fb7185", glow: "rgba(251,113,133,0.15)" },
        { label: "Customers", value: data.kpis.customers.toLocaleString(), icon: Users, color: "#14b8a6", glow: "rgba(20,184,166,0.15)" },
                    ...
                    <>
                        ...
                        <div style={{
                            ...
                            {data.modeSplit.map((m, i) => {
                                const cfg = MODE_COLORS[m.label] || { color: "#3b82f6", icon: <Bike size={20} /> };
                                return (
                        ...
                        <div style={{
                                ...
                                {data.recentOrders.length === 0 ? (
                                    ...
                                    >
                                        <div style={{
                                            ...
                                            background: (MODE_COLORS[o.mode] || MODE_COLORS['Delivery']).color + "14",
                                            border: `1px solid ${(MODE_COLORS[o.mode] || MODE_COLORS['Delivery']).color}33`,
                                            display: "flex", alignItems: "center", justifyContent: "center",
                                            fontSize: 14,
                                        }}>
                                            {(MODE_COLORS[o.mode] || MODE_COLORS['Delivery']).icon}
                                        </div>

                                        <div style={{ flex: 1, minWidth: 0 }}>
                                            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 2 }}>
                                                <span style={{ fontSize: 11, fontFamily: "monospace", color: "#3b82f6", fontWeight: 700 }}>
                                                    {o.id}
                                                </span>
                            ...
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                                        <div style={{
                                            ...
                                            <XCircle size={13} style={{ color: "#fb7185" }} />
                                        </div>
                                ...
                                {data.recentCanceledOrders.length === 0 ? (
                                    ...
                                    >
                                        ...
                                        <div style={{ flex: 1, minWidth: 0 }}>
                                            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 2 }}>
                                                <span style={{ fontSize: 11, fontFamily: "monospace", color: "#fb7185", fontWeight: 700 }}>
                                                    {o.id}
                                                </span>
                                                <span style={{ fontSize: 12, fontWeight: 600, color: "#fff", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                                                    {o.name}
                            ...
                            <div style={{
                                        ...
                                        <div key={p.name}>
                                            ...
                                            <div style={{
                                                ...
                                                <div style={{
                                                    height: "100%", borderRadius: 99,
                                                    background: i === 0
                                                        ? "linear-gradient(90deg, #3b82f6, #ffb380)"
                                                        : `rgba(59,130,246,${0.7 - i * 0.12})`,
                                                    width: `${p.pct}%`,
                                                    boxShadow: i === 0 ? "0 0 8px rgba(59,130,246,0.6)" : "none",
                                ...
                                <div style={{
                                    ...
                                    <span style={{ fontSize: 14, fontWeight: 800, color: "#3b82f6", letterSpacing: "-0.02em" }}>
